...
<script>
    ...
    <div class="container">
        ...
        <input type="hidden" name="notcNo" value="${inqryDTO.inqryNo}"/>
        ...
        <colgroup>
            ...
            <table id="titleForm">
                <tr>
                    <td id="titleFormFirst">${inqryDTO.title}</td>
                </tr>

                <tr>
                    <td id="titleFormSecond"><fmt:formatDate value="${inqryDTO.regDttm}" pattern="yyyy-MM-dd" /></td>
                </tr>
            </table>
            ...
            <table id="contentForm">
                <tr>
                    <td class="detail-cont">${inqryDTO.content}
