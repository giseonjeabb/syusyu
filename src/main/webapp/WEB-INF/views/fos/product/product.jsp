                    ...
                    <div class="goods-info">
                        <div class="goods-desc">
                                ...
                                <div class="btn-wrap btn-active-wrap">
                                    ...
                                    <div class="pbw-wrap">
                                        <button type="button" class="btn icon share btn-share" data-type="share"><span
                                                class="text">공유하기</span></button>
                                        <div class="popup-wrap popup-share">
                                            <div class="popup-layer">
                                                <div class="popup-head">
                                                    <h4>공유하기</h4>
                                                    <a href="javascript:void(0);" class="btn icon remove_19"
                                                       data-btn="false">close</a>
                                                </div>
                                                <div class="popup-content" data-type="share-box">

                                                    <div class="popup-bottom-share-content">

                                                        <a href="javascript:" data-type="kakao"
                                                           key="1303d0818dd6a7080ae5b1275c4056c5">
                                                            <img src="<c:url value='${imgUrl}/icon_sns_kakao.png'/>"
                                                                 alt="카카오톡 공유하기">
                                                            <p>카카오톡</p>
                                                        </a>
                                                        ...
                                                        <a href="javascript:" data-type="facebook">
                                                            <img src="<c:url value='${imgUrl}/icon_sns_facebook.png'/>"
                                                                 alt="페이스북 공유하기">
                                                            <p class="">페이스북</p>
                                                        </a>
                                                    ...
                                                    <div class="url-copy">
                                                        ...
                                                        <button type="button" class="btn clipboard" data-type="link">
                                                            <span>복사</span></button>
                                                    </div>
                                    ...
                                    <span class="g-cont">
                                        <span class="deli-info">
                                            ...
                                            <button type="button" class="btn ar-r icon mark tooltip-btn"
                                                    onclick="bta.alert.open('.deliveryPopup');">
                                                <span class="ty2"></span>
                                            </button>
                                        </span>
                                ...
                                <li class="flex al-center">
                                    ...
                                    <span class="g-cont">
											<div class="item-qty" data-name="item-total-cnt">
													...
													<input class="item_qty_count" name="cqty" type="number" title="상품수량"
                            ...
                            <div class="option-select-item" idx="{{idx}}">
                                <p class="option-tit">
                                    <span>{{text}}</span>
                                    <button type="button" class="btn icon remove_18" data-type="del"><span>옵션삭제</span>
                                    </button>
                                </p>
                                <div class="option-control-box">
                                    <div class="item-qty">
                                        <input type="hidden" name="copt" price="0"/>
                                        <input class="item_qty_count" name="cqty" type="number" title="상품수량" value="1"
                                               maxlength="4" min="1" max="0" stock="0">
                                    ...
                                    <div class="option-price">
                                        <del>0원</del>
                                        <span data-name="price"></span><span class="won">원</span></div>
                                </div>
                            </div>
                            </script>
                            ...
                            <div class="btn-area">
                                ...
                                <a href="javascript:" class="btn ty4 c-ty2 icon gift" data-name="order-by"
                                   data-type="gift" data-boolean="false"><span>선물함 담기</span></a>
                                <a href="javascript:" class="btn ty4 c-ty2" data-name="order-by"
                                   data-type=""><span>장바구니</span></a>
                                <a href="javascript:" class="btn ty4 c-ty1" data-name="order-by"
                                   data-type="order "><span>바로구매</span></a>
                        ...
                        <div class="tab-group-cont content-mini left-case"><!-- 상세정보 -->
                            ...
                            <div class="tab-cont goods-detail-img">
                                        ...
                                        <div class="def-box-content">
                                            <div class="star-avg">
                                                <div class="avg-per">
                                                    ...
                                                    <p class="txt">총 <span
                                                            name="tab_review_size">${productDetail.revwCnt}</span>건</p>
                                                </div>
                                            </div>
                                            <div class="sorting">
								<span class="chkbox">
									<label>
										...
										<span class="text">포토후기만 보기</span>
                                            ...
                                            <div class="reviews-list-wrap" page-no="1" total-size="0" total-page="1"
                                                 total-review="0" rating-avg="0" rating-star="0">
                                        ...
                                        <div class="fold-content">
                                            ...
                                            <div class="con mb-40"
                                                ...
                                                <ul class="list ty1"
                                                    ...
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);"></li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        부분 취소/반품 시 쿠폰을 사용한 경우 <span style="letter-spacing: -0.4px;">귀책 주체와 상관 없이&nbsp;</span><u>할인
                                                        금액을 제외한 실 결제 금액에 대해 환불돼요.</u></li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        <span style="letter-spacing: -0.4px;">계좌이체 결제한 경우 주문 시 입금자명과 동일한 계좌로 환불받을 수 있어요.&ZeroWidthSpace;</span>
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        상품 검수 완료 후 입금되어 시간이 소요될 수 있으니 조금만 기다려 주세요.
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        타 택배사 이용 시 선불 발송만 가능해요. (착불 불가)
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="con mb-40"
                                                ...
                                                <h6 class="sub-tit"
                                                    style="margin: 0px 0px 10px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; font-size: 16px;">
                                                    [취소/교환/반품 불가&ZeroWidthSpace;]</h6>
                                                <ul class="list ty1"
                                                    style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        다음의 경우 교환/반품 기간 내라도 취소/교환/반품/환불이 불가해요. (제품 불량 및 하자, 오배송 제외)&ZeroWidthSpace;
                                                        &ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        상품 수령일로부터 7일이 경과한 경우&ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        포장을 개봉하거나 상품을 취식한 경우
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        구성품 또는 사은품을 반납하지 않은 경우
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        신선, 냉장, 냉동상품에 대해 시간이 경과되어 상품의 가치가 현저히 감소한 경우
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="con mb-40"
                                                ...
                                                <ul class="list ty1"
                                                    style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        고객 단순 변심으로 인한 교환 및 반품 시 박스당 왕복 6,000원의 배송비가 부과돼요.
                                                    </li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        취소/반품으로 무료 배송 조건이 충족되지 못할 시 배송비가 추가로 부과될 수 있어요.
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        제품 하자로 인한 반품 비용은 당사에서 부담합니다.
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="con mb-40"
                                                ...
                                                <h6 class="sub-tit"
                                                    style="margin: 0px 0px 10px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; font-size: 16px;">
                                                    [환불 규정]&ZeroWidthSpace;&ZeroWidthSpace;</h6>
                                                <ul class="list ty1"
                                                    style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        반품된 상품이 물류센터로 입고되어 검수가 완료되면 반품완료 안내를 드립니다.&ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        환불은 반품완료 후 영업일 기준 평균 7일이 소요됩니다.&ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        카드로 결제하신 경우 영업일 기준 평균 4일~7일의 승인취소 기간이 소요됩니다.&ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        현금으로 결제하신 경우 환불계좌로 입금되며 평균 4일~7일의 환불기간이 소요됩니다.&ZeroWidthSpace;
                                                    </li>
                                                    <li style="margin: 2px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        결제 수단에 따라 환불기간이 평균일보다 길게 소요될 수 있습니다.&ZeroWidthSpace;
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="con mg-0"
                                                 style="margin-bottom: 44px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; font-family: Pretendard, sans-serif; letter-spacing: -0.4px; margin-top: 0px !important; margin-right: 0px !important; margin-left: 0px !important;">
                                                <h6 class="sub-tit"
                                                    style="color: rgb(29, 29, 27); font-size: 16px; margin: 0px 0px 10px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline;">
                                                    [취소/반품 정책]</h6>
                                                <ul class="list ty1"
                                                    style="color: rgb(29, 29, 27); font-size: 16px; margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        주문 취소는 [결제완료] 상태일 때 마이페이지 &gt; 주문내역 상세페이지에서 가능합니다.
                                                    </li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        반품은 [배송완료] 상태일 때 마이페이지 &gt; 주문내역 상세페이지에서 가능합니다.
                                                    </li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        구매확정 시 취소,교환,반품이 불가합니다.&nbsp;
                                                    </li>
                                                    <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 26px; color: rgb(51, 51, 51);">
                                                        (제품 불량, 하자, 오 배송 제외)
                                                    </li>
                                ...
                                <div class="tab-cont goods-qna">
                                    ...
                                    <h4 class="tit">상품문의 <strong class="count color-1" name="tab_qna_size">0</strong>
                                    </h4>
                                    ...
                                    <div class="goods-qna-list-wrap" page-no="1" total-size="0" total-page="1"
                                         total-qna="0">
                                ...
                                <div class="move-container-right">
                                            ...
                                            <div class="option-select-item">
                                                ...
                                                <div class="option-control-box">
                                                    <div class="item-qty">
                                                        ...
                                                        <input class="item_qty_count" name="cqty" type="number"
                                                               title="상품수량" value="1" maxlength="4" min="1" max="0"
                                                               stock="33">
                                    ...
                                    <div class="bottom-wrap">
                                        ...
                                        <div class="btn-wrap flex space-between">
                                            ...
                                            <button type="button" class="btn ty4 free w-92 c-ty2 gift"
                                                    data-name="order-by" data-type="gift" data-boolean="false"><span>선물함 담기</span>
                                            </button>

                                            <button type="button" class="btn ty4 free w-94 c-ty2" data-name="order-by"
                                                    data-type=""><span>장바구니</span></button>
                                            <button type="button" class="btn ty4 free w-94 c-ty1" data-name="order-by"
                                                    data-type="order "><span>바로구매</span></button>
                                        ...
                                        <div class="sw-cont sw-items normal-type n4" data-nth="4" data-swsb="40">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="prd-item">
                                                        <div class="thumbs hover">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=886&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                               target="_self">
                                                                <img src="https://ottogi-mall-s3.s3.ap-northeast-2.amazonaws.com/data/product/list/20221125/1687848566410jtbFu.1hbghv3g8o411.jpg"
                                                                     alt="맛있는 참치김치치즈볶음밥(용기) 230G">
                                                            </a>
                                                        </div>
                                                        <div class="desc">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=886&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                            ...
                                                            <div class="prd-item-btn">
                                                                <button type="button" class="btn icon cart add-cart-bt">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="prd-item">
                                                        <div class="thumbs hover">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=882&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                               target="_self">
                                                                <img src="https://ottogi-mall-s3.s3.ap-northeast-2.amazonaws.com/data/product/list/20221125/23010020_1.jpg"
                                                                     alt="맛있는 새우볶음밥(용기) 230G">
                                                            </a>
                                                        </div>
                                                        <div class="desc">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=882&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="prd-item">
                                                        <div class="thumbs hover">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=885&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                               target="_self">
                                                                <img src="https://ottogi-mall-s3.s3.ap-northeast-2.amazonaws.com/data/product/list/20221125/1687848462657irJJ8.1hbd9px084ab4.jpg"
                                                                     alt="맛있는 베이컨치즈볶음밥(용기) 230G">
                                                            </a>
                                                        </div>
                                                        <div class="desc">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=885&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="prd-item">
                                                        <div class="thumbs hover">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=888&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
                                                               target="_self">
                                                                <img src="https://ottogi-mall-s3.s3.ap-northeast-2.amazonaws.com/data/product/list/20221125/23010048_1.jpg"
                                                                     alt="오즈키친 철판낙지볶음밥 450G">
                                                            </a>
                                                        </div>
                                                        <div class="desc">
                                                            <a href="https://lc.recopick.com/1/banner/3365/pick?uid=27761726.1687853370651&amp;source=916&amp;pick=888&amp;method=4&amp;channel=detail_down&amp;reco_type=item-item&amp;product_type=R&amp;reco_list=%5B%22886%22%2C%22882%22%2C%22885%22%2C%22888%22%5D&amp;tag=V"
    ...
    <div class="popup-wrap deliveryPopup" active-popup="true">
        <div class="popup-layer w-430 pd-c-30">
            ...
            <div class="popup-content">
                <div class="inner">
                    <div class="mb-40"
                         style="margin-top: 0px; margin-right: 0px; margin-left: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; color: rgb(29, 29, 27); font-family: Pretendard, sans-serif; font-size: 16px; letter-spacing: -0.4px; background-color: rgb(255, 255, 255); margin-bottom: 40px !important;">
                        <h6 class="popup-sub-tit"
                            style="margin: 0px 0px 15px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; font-size: 18px; line-height: 21px; color: rgb(51, 51, 51);">
                            무료배송 기준</h6>
                        <ul class="list ty3"
                            style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                            <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 10px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 20px; color: rgb(51, 51, 51);">
                                동일배송 유형별 상품 30,000원 이상 구매 시 무료배송
                            </li>
                            <li style="margin: 3px 0px 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 10px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 20px; color: rgb(51, 51, 51);">
                                무료배송 상품 구매 시
                            </li>
                        </ul>
                    </div>
                    <div class="mb-40"
                         style="margin-top: 0px; margin-right: 0px; margin-left: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; color: rgb(29, 29, 27); font-family: Pretendard, sans-serif; font-size: 16px; letter-spacing: -0.4px; background-color: rgb(255, 255, 255); margin-bottom: 40px !important;">
                        <h6 class="popup-sub-tit mb-16"
                            style="margin: 0px 0px 15px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; font-size: 18px; line-height: 21px; color: rgb(51, 51, 51);">
                            배송 유형별 상품</h6>
                        <div class="tbl ty2 tbl-center"
                             style="margin: 0px; box-sizing: border-box; border-width: 2px 0px 0px; border-top-style: solid; border-right-style: initial; border-bottom-style: initial; border-left-style: initial; border-top-color: rgb(51, 51, 51); border-right-color: initial; border-bottom-color: initial; border-left-color: initial; padding: 0px; border-image: initial; vertical-align: baseline;">
                            <table class="__se_tbl_ext"
                                   style="margin: 0px; border-width: 0px; border-style: initial; border-color: inherit; padding: 0px; border-image: initial; vertical-align: baseline; table-layout: fixed; width: 350px; max-width: 100%; border-collapse: collapse; border-spacing: 0px;">
                                <colgroup
                                        style="margin: 0px; box-sizing: border-box; border-width: 0px; border-style: solid; border-color: currentcolor;">
                                    <col style="width:120px; margin: 0px; box-sizing: border-box; border-width: 0px; border-style: solid; border-color: currentcolor;">
                                    <col style="width:auto; margin: 0px; box-sizing: border-box; border-width: 0px; border-style: solid; border-color: currentcolor;">
                                </colgroup>
                                <tbody style="margin: 0px; box-sizing: border-box; border-width: 0px; border-style: solid; border-color: currentcolor;">
                                <tr style="margin: 0px; box-sizing: border-box; border-width: 0px; border-style: solid; border-color: currentcolor;">
                                    <td class="fw-6"
                                        style="width:120px; margin: 0px; box-sizing: border-box; border-width: 0px 0px 1px; border-style: solid; border-color: currentcolor currentcolor rgb(238, 238, 238); font-weight: 600 !important; padding: 20px 0px; line-height: 24px;">
                                        상온 배송
                                    </td>
                                    <td style="width:auto; margin: 0px; box-sizing: border-box; border-width: 0px 0px 1px; border-style: solid; border-color: currentcolor currentcolor rgb(238, 238, 238); padding: 20px 0px; line-height: 24px;">
                                        <ul class="list ty5"
                                            style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                                            <li class="etc-ty1"
                                                style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; line-height: 29px; color: rgb(85, 85, 85);">
                                                <span class="color-1"
                                                      style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; color: rgb(211, 35, 58) !important;">실온</span>표기상품
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width:auto; margin: 0px; box-sizing: border-box; border-width: 0px 0px 1px; border-style: solid; border-color: currentcolor currentcolor rgb(238, 238, 238); padding: 20px 0px; line-height: 24px;">
                                        <ul class="list ty5"
                                            ...
                                            <li class="etc-ty1"
                                                style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 8px; vertical-align: baseline; position: relative; line-height: 29px; color: rgb(85, 85, 85);">
                                                <span class="color-9"
                                                      style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; color: rgb(10, 48, 158) !important;">냉장·냉동</span>표기상품
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                    ...
                    <div style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; background-color: rgb(255, 255, 255);">
                        <h6 class="popup-sub-tit"
                            style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px; color: rgb(51, 51, 51); font-size: 18px; margin: 0px 0px 15px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; line-height: 21px;">
                            배송기간</h6>
                        <ul class="list ty3"
                            style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px; color: rgb(29, 29, 27); font-size: 16px; margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                            <li style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 10px; vertical-align: baseline; position: relative; font-size: 15px; line-height: 20px; color: rgb(51, 51, 51);">
                                입금/결제 확인 후 평균 2일~4일 (영업일 기준)
                            </li>
                        </ul>
                        <div style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px;"><font color="#333333"><span
                                style="font-size: 15px;"><br></span></font></div>
                        <div style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px;"><font color="#333333"><span
                                style="font-size: 15px;"></span></font></div>
                        <h6 class="popup-sub-tit"
                        ...
                        <ul class="list ty3"
                            style="margin: 0px; box-sizing: border-box; border: 0px; padding: 0px; vertical-align: baseline; list-style: none;">
                            <li style="color: rgb(51, 51, 51); font-family: Pretendard, sans-serif; font-size: 15px; letter-spacing: -0.4px; margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 10px; vertical-align: baseline; position: relative; line-height: 20px;">
                                롯데택배
                            </li>
                            <li style="color: rgb(51, 51, 51); font-family: Pretendard, sans-serif; font-size: 15px; letter-spacing: -0.4px; margin: 0px; box-sizing: border-box; border: 0px; padding: 0px 0px 0px 10px; vertical-align: baseline; position: relative; line-height: 20px;">
                                배송조회 및 문의는 마이페이지 &gt; 주문배송조회 또는 1588-2121(롯데택배)에서 가능합니다.&ZeroWidthSpace; 단 당사의 사정에 따라
                                택배사는 변경될 수 있습니다.&ZeroWidthSpace;&ZeroWidthSpace;
                            </li>
                        </ul>
                        <div style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px;"></div>
                        <div style="font-family: Pretendard, sans-serif; letter-spacing: -0.4px;"><span
                                style="color: rgb(51, 51, 51); font-size: 15px; letter-spacing: -0.4px;"></span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="popup-wrap" id="updatePwPopup" active-popup="true">
        <div class="popup-layer w-510">
                    ...
                    <div class="content-title etc-ty4 mt-20">
                        <div class="inner-content ta-c w-full">
                            ...
                            <p class="desc etc-ty1">
                                장기간 비밀번호를 변경하지 않고 동일한 비밀번호를 사용 중이신 경우, 개인정보를 안전하게 보호하고 개인정보도용으로 인한 피해를 방지하기 위해 주기적으로
                                비밀번호를 변경하도록 안내해 드리고 있습니다.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="popup-btn-area">
                <a href="https://www.ottogimall.co.kr/front" class="btn popup-btn ty4 c-ty8 delayPwReset"
                   userno="0"><span>다음에</span></a>
                <a href="https://www.ottogimall.co.kr/front/mypage/my_modify"
                   class="btn popup-btn ty4 c-ty9 pwReset"><span>변경하기</span></a>
            </div>
        </div>
    </div>
