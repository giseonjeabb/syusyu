...
public class ProdOptCombDAOImpl implements ProdOptCombDAO {
     ...
     *
     * @param prodOptCombDTOList 상품의 옵션 조합 정보를 담고 있는 DTO 객체.
     ...
     */
    @Override
    public int insertProdOptCombList(List<ProdOptCombDTO> prodOptCombDTOList) throws Exception{
        return session.insert(namespace+"insertProdOptComb", prodOptCombDTOList);
    }
