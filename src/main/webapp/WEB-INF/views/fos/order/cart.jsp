...
<head>
    <style>
        @import url(${cssUrlFos} /member/style2.css);
    </style>
</head>
<main>
    ...
    <div class="inner-content move-container">
            ...
            <div class="chk-box-wrap cart-area mt-40">
                <div class="all-option-box">
                    ...
                    <div class="select-btn">
                        <span><button type="button" class="btn btn-text-type btt1"
                                      onclick="removeBasket(null);">선택삭제</button></span>
                    </div>
                </div>
                            ...
                            <li>
                                <div class="chk-area">
                                    <div class="chkbox single">
                                        <label>
                                            <input type="checkbox" class="chk-point" name="cb" checked=""
                                                   onchange="cbChangeEvent();">
                                ...
                                <div class="item-area">
                                    <div class="prd-item etc-ty1 ">
                                        <input type="hidden" name="basket" value="376933">
                                        ...
                                        <div class="thumbs hover">
                                            <a href="https://www.ottogimall.co.kr/front/product/2254">
                                                <img src="${imgUrl}/product/${cartProduct.repImg}" alt="이미지">
                                            </a>
                                        </div>
                                        <div class="desc">
                                            <a href="javascript:">
                                ...
                                <div class="item-qty-area">
                                    <div class="item-qty" data-name="basket-item-qty">
                                        ...
                                        <button type="button" class="btn icon minus"><span class="text">상품수량 빼기</span>
                                        </button>
                                        <button type="button" class="btn icon plus"><span class="text">상품수량 더하기</span>
                                        </button>
                                    </div>
                                </div>
                                <div class="price-arae">
                                    <p class="amount">${cartProduct.salePrc}<span class="won">원</span> </p>
                                </div>
                                <div class="remove-area">
                                    <button type="button" class="btn icon remove_20" onclick="removeBasket(376933);"><span
        ...
        <div class="move-container-right">
            ...
            <button type="button" class="btn ty5 c-ty1 w-full" onclick="goOrder();"><span
            ...
            <div class="popup-layer w-910">
                ...
                <div class="popup-fix-cont">
                    <div class="r-side">
                        ...
                        <button type="button" class="btn ty1 c-ty6 free w-120 ml-5" onclick="connectEmail();"><span>메일로 보내기</span>
                        </button>
