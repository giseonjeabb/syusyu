...
<form name="FrmClaim" id="frm_claim" method="post">
        ...
        <div class="tbl mt-40">
            ...
            <div class="order-history-list detail chk-wrap">
                <div class="order-type">
                    <div class="chkbox">
                        <label>
                            <input type="checkbox" class="chk-all-part">
                            <span class="text fw-7 sun fz-18">실온</span>
                        </label>
                    </div>
                </div>
                    ...
                    <div class="order-item ux-ord-prod">
                        <div class="chk-area mr-10">
                            <div class="chkbox single">
                                <label>
                                    <input type="checkbox" class="chk-point" name="cb" checked="checked">
        ...
        <div class="tbl ty2 mt-18">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select id="reason_base" name="reasonBase" choosed="" class="selectbox ty1 w-full"
                                required="주문취소 사유">
                            <option value="">사유를 선택해 주세요.</option>
                            <option value="66" impute="buyer">다른 상품 잘못 주문</option>
                            <option value="69" impute="buyer">옵션 변경</option>
                            <option value="70" impute="buyer">구매의사 취소</option>
                            <option value="72" impute="buyer">고객변심</option>
                            <option value="73" impute="seller">기타</option>
                            <option value="74" impute="seller">재고부족</option>
                        </select>
                        <div class="textarea word-chker mt-10">
                            <textarea class="h-143" name="reasonDetail" id="reason_detail" maxlength="50"
    ...
    <div id="box_claim_calc" style="display: none;"></div>


    <div class="btn-area mt-40">
        <a href="#" class="btn ty4 c-ty1 bt-claim-calc"><span>환불예정금액 계산하기</span></a>
    </div>
